...
| `benchmarks/qwen35-27b-tp2-knowledge-eval.md` | Qwen3.5-27B TP2 (2× RTX 4090, batched eager decode) knowledge benchmarks vs official: C-Eval 88.11 vs 90.5 (full 1346, thinking-cap truncation rerun-merged, in cross-harness band); MMLU-Redux 94.09 vs 93.2 was scored with the pre-fix first-capital extractor — rerun-pending, do not cite; MMLU-Pro/SuperGPQA partial smokes only. |
