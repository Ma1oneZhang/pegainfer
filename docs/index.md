...
| `models/qwen35/tp-implementation.md` | Qwen3.5 TP landed through Phase 2b + batched eager TP decode on #870 (2026-08, 2× RTX 4090): #870's Phase 1/P2A lifecycle and ID contracts kept; GDR state sharded per rank (27B TP2 fits 48 GB pairs); one batched forward per decode step (27B: 292 tok/s aggregate ×16 vs 24.9 before). 9B/27B TP2 HF + e2e gates pass. TP CUDA Graph stays fail-closed. |
